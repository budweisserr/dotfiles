...
local top = function(c, args)
	local corner_left_img = shapes.create_corner_top_left({
		...
		stroke_source_inner = shapes.gradient(args.stroke_color_inner_top, args.stroke_color_inner_sides, edge_height),
		stroke_source_outer = shapes.gradient(args.stroke_color_outer_top, args.stroke_color_outer_sides, edge_height),
